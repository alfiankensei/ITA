    ...
    <div class="col-lg-9 mb-lg-0 mb-4">
        <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
                <h3 class="text-capitalize">Lalin Per Jam (Jalur {{$jenisLalin}})</h3>
            </div>
...
<script>
    ...
    function getChart{{$jenisLalin}}() {
        ...
        $.ajax({
                    url: "/data/chart/{{$jenisLalin}}?tanggal={{request()->tanggal}}&lokasi={{request()->lokasi}}",
                    success: (res) => {
    ...
    setInterval(() => {
        ...
        $.ajax({
            url: "/data/{{$jenisLalin}}?tanggal={{request()->tanggal}}&lokasi={{request()->lokasi}}",
            success: (res) => {
